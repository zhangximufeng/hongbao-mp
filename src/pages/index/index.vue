        ...
        <view class="getHongbao__list">
          <view class="getHongbao__item" v-for="(item, index) in userReceiving" wx:key="index">
            ...
            <view class="getHongbao__itemOther">
              <view class="getHongbao__itemPhone">{{item.application === 0 ? '美团' : '饿了么'}} {{item._phone}}</view>
    ...
    methods: {
      ...
      async scanCode (event) {
        try {
          ...
          const result = 'B2022027D18A15ECC0F68899A2B66CCD40DCB6427289C549940CAD6590CAF97CF9D592E481554752C849CB6570003AF47FBCF71489532F4A23083A83D1A9E12F'
